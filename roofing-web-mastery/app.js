  ...
  const labs = config.labs || [
    {
      ...
      description: "Define the business and customer system before designing pages.",
      task: "Document priority jobs, economics, service areas, audiences, search intents, offers, proof, capacity, competitors, conversion actions, measurement, constraints, and explicit non-goals.",
      proof: "Another strategist can make the same page-priority decisions from the brief."
    },
    {
      id: "site-blueprint",
      title: "Sitemap and intent blueprint",
      description: "Map search and customer needs to a lean architecture.",
      task: "Create the sitemap, page purpose, target intent, primary CTA, proof requirements, internal links, template type, owner, and criteria for creating or rejecting location pages.",
      proof: "Every page has one distinct job and no orphaned high-value path."
    },
    {
      id: "page-build",
      title: "Mobile service-page prototype",
      description: "Turn strategy into a usable conversion page.",
      task: "Build or wireframe one priority roofing page with hero, trust, process, project proof, decision content, FAQs, internal links, CTA, form/call path, accessibility states, and measurement notes.",
      proof: "A test user can identify service, fit, proof, and next step without coaching."
    },
    {
      id: "technical-launch",
      title: "Technical SEO launch gate",
      description: "Prove the production site is crawlable, indexable, functional, and measurable.",
      task: "Audit response codes, robots, noindex, canonicals, redirects, sitemap, rendering, internal links, mobile, CWV, schema, forms, analytics, Search Console, security, backups, and rollback.",
      proof: "No unresolved blocker can silently remove priority pages or lose leads."
    },
    {
      id: "source-readiness",
      title: "SEO and AEO source-readiness audit",
      description: "Evaluate whether a page can be found, understood, trusted, and cited.",
      task: "Review indexability, snippet eligibility, direct answers, entity clarity, first-hand evidence, authorship/review, citations, dates, text/media, internal links, schema alignment, crawler controls, and unsupported claims.",
      proof: "The page remains valuable to a homeowner even if no AI system cites it."
    },
    {
      id: "rank-grid",
      title: "Local and organic rank-grid diagnostic",
      description: "Summarize a consistent 5×5 visibility scan without mistaking rank for revenue.",
      task: "Enter 25 ranks from left-to-right, top-to-bottom. Use 21 for not found beyond rank 20. Interpret average, median, top-3 share, top-10 share, and not-found share alongside query intent, location, competitors, and qualified demand.",
      proof: "The diagnosis separates observed pattern, likely cause, uncertainty, business value, and next test.",
      calculator: "rank"
    },
    {
      id: "measurement",
      title: "Search and lead measurement system",
      description: "Connect rankings and traffic to qualified roofing outcomes.",
      task: "Define Search Console, analytics, calls, forms, consent, UTMs, qualified stages, CRM, rank tracking, GBP, AI-observation limits, dashboards, alerts, baselines, owners, and reporting caveats.",
      proof: "The report distinguishes impressions, visits, leads, qualified opportunities, and customers."
    },
    {
      id: "capstone",
      title: "Capstone account audit",
      description: "Integrate the entire operating system.",
      task: "Plan and audit a complete roofing website. Produce discovery, query map, sitemap, wireframes, content/proof, design system, build QA, technical SEO, entity/schema, SEO/AEO source readiness, crawler policy, accessibility, CWV, tracking, rank grid, launch plan, 30-day roadmap, and client walkthrough.",
